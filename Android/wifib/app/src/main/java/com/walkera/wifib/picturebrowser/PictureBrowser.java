...
public class PictureBrowser extends Activity {
    ...
    /* renamed from: com.walkera.wifib.picturebrowser.PictureBrowser.1 */
    ...
    /* renamed from: com.walkera.wifib.picturebrowser.PictureBrowser.2 */
    class C00332 implements OnItemLongClickListener {

        /* renamed from: com.walkera.wifib.picturebrowser.PictureBrowser.2.1 */
        class C00311 implements DialogInterface.OnClickListener {
        ...
        /* renamed from: com.walkera.wifib.picturebrowser.PictureBrowser.2.2 */
        class C00322 implements DialogInterface.OnClickListener {
            C00322() {
            }
        ...
        public boolean onItemLongClick(AdapterView<?> adapterView, View view, int position, long id) {
            ...
            PictureBrowser.this.builder.setMessage("Are you sure to delete this file!").setPositiveButton("YES", new C00311(pos));
            PictureBrowser.this.builder.setNegativeButton("NO", new C00322());
    ...
    /* renamed from: com.walkera.wifib.picturebrowser.PictureBrowser.3 */
    class C00343 implements OnItemClickListener {
        C00343() {
        }
    ...
    /* renamed from: com.walkera.wifib.picturebrowser.PictureBrowser.4 */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.photoBtn.setOnClickListener(new C00301());
        this.listView.setOnItemLongClickListener(new C00332());
        this.listView.setOnItemClickListener(new C00343());
    }
    ...
    private List<Map<String, Object>> inflateListView() {
        ...
        if (Flag) {
            ...
            this.builder.setMessage("No SD card error!").setPositiveButton("OK", new C00354());
