...
public class UpdateManager {
    ...
    /* renamed from: com.walkera.wifib.UpdateManager.1 */
    ...
    /* renamed from: com.walkera.wifib.UpdateManager.2 */
    class C00192 implements OnClickListener {
        C00192() {
        }
    ...
    /* renamed from: com.walkera.wifib.UpdateManager.3 */
    class C00203 implements OnClickListener {
        C00203() {
        }
    ...
    /* renamed from: com.walkera.wifib.UpdateManager.4 */
    class C00214 implements OnClickListener {
        C00214() {
        }
    ...
    private boolean isUpdate() {
        ...
        Log.w("UpdateManager", " versionCode = " + this.versionCode);
        Log.w("UpdateManager", " versionName = " + this.versionName);
        InputStream inStream = ParseXmlService.class.getClassLoader().getResourceAsStream("version.xml");
        if (inStream == null) {
            Log.w("UpdateManager", " ---------------isUpdate false--------------- ");
            return false;
        }
        try {
    ...
    private void showNoticeDialog() {
        ...
        builder.setPositiveButton(R.string.soft_update_updatebtn, new C00192());
        builder.setNegativeButton(R.string.soft_update_later, new C00203());
        builder.create().show();
    }
    ...
    private void showDownloadDialog() {
        ...
        builder.setView(v);
        builder.setNegativeButton(R.string.soft_update_cancel, new C00214());
