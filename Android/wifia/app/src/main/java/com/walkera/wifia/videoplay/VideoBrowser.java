...
public class VideoBrowser extends Activity {
    ...
    /* renamed from: com.walkera.wifia.videoplay.VideoBrowser.1 */
    class C00341 implements OnItemLongClickListener {

        /* renamed from: com.walkera.wifia.videoplay.VideoBrowser.1.1 */
        ...
        /* renamed from: com.walkera.wifia.videoplay.VideoBrowser.1.2 */
        ...
        public boolean onItemLongClick(AdapterView<?> adapterView, View view, int position, long id) {
            ...
            VideoBrowser.this.builder.setMessage("Are you sure to delete this file!").setPositiveButton("YES", new C00321(pos));
            VideoBrowser.this.builder.setNegativeButton("NO", new C00332());
    ...
    /* renamed from: com.walkera.wifia.videoplay.VideoBrowser.2 */
    class C00352 implements OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
            if (VideoBrowser.this.isVideoFile(VideoBrowser.this.currentFiles[position].getName())) {
                ...
                VideoBrowser.this.startActivity(Intent.createChooser(intent, null));
                return;
            }
    ...
    /* renamed from: com.walkera.wifia.videoplay.VideoBrowser.3 */
    class C00363 implements OnClickListener {
        C00363() {
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.listView.setOnItemLongClickListener(new C00341());
        this.listView.setOnItemClickListener(new C00352());
    }
    ...
    private List<Map<String, Object>> inflateListView() {
        ...
        if (Flag) {
            ...
            this.builder.setMessage("No SD card error!").setPositiveButton("OK", new C00363());
