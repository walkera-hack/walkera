...
public class Browser extends Activity implements OnItemSelectedListener, ViewFactory {
    ...
    /* renamed from: com.walkera.wifia.picturebrowser.Browser.1 */
    ...
    /* renamed from: com.walkera.wifia.picturebrowser.Browser.2 */
    ...
    /* renamed from: com.walkera.wifia.picturebrowser.Browser.3 */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (ImageList != null && ImageList.size() != 0) {
            ...
            g.setOnItemClickListener(new C00201());
        }
    }
    ...
    private List<String> getImagesFrom(File filepath) {
        ...
        if (Flag) {
            ...
            this.builder.setMessage("No SD card error!").setPositiveButton("OK", new C00212());
            ...
            if (files == null || files.length == 0) {
                this.builder = new Builder(this);
                this.builder.setMessage("No flight picture for browsing...").setPositiveButton("OK", new C00223());
                this.ad = this.builder.create();
                this.ad.show();
            } else {
                counts = 0;
